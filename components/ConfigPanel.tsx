...
import { X, UserCircle, Phone, Linkedin, Trash2 } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/40 backdrop-blur-sm transition-opacity" onClick={onClose}>
      ...
      >
        ...
        <div className="space-y-6 flex-1 overflow-y-auto">
          <p className="text-xs text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-white/5 p-4 rounded border border-zinc-200 dark:border-white/5 leading-relaxed">
            Data persists locally. This information auto-populates the header of your generated documents.
          </p>
